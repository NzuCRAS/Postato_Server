...
本⽂是关于 AI 辅助编码的全⾯实战指南，基于天猫新品团队的实践经验，从问题本质到解决⽅案，从理论框架到实战案例，系统性地介绍如何让 AI 更好地完成⼤部分需求。本文分上下两篇， [天猫新品营销技术团队AI编码实战指南（上）](https://mp.weixin.qq.com/s?__biz=MzAxNDEwNjk5OQ==&mid=2650543356&idx=1&sn=c460ef2f9e36ffbdc1083dd36c2595b6&scene=21#wechat_redirect)包含：1. 现状与问题诊断 - 深⼊剖析 AI ⽣码的四⼤痛点（写不对、写不好、写不了、改不动），并从项⽬知识、⽤户输⼊、任务复杂度、⾃检机制、模型能⼒等五个维度提供针对性解法。2. ⽅法论与优化思路 - 提出"最⼤化复⽤、⾃然语⾔第⼀、⼆⼋定律"三⼤核⼼思想，并沿着"前置准备→开发前→开发中→完成后"的全流程，给出每个节点的可落地优化⼿段。3. 分场景实战案例 - 根据验收标准和代码质量要求，将需求分为"需求驱动型"和"⼯程主导型"两类，通过⼩⼆端列表⻚和C端复杂业务的完整案例，展示不同场景下的最佳实践。本篇包含：4. 团队建设经验 - 分享新品团队在⼩⼆端（后端全栈化）和C端（视图分离、知识库建设、⼯作流沉淀）两个⽅向的探索，包括⼯具建设、⽂档沉淀、知识库⽅案等具体落地内容。5. 实⽤技巧集锦 - 涵盖 UI 重构、复杂 Prompt 构建、数据转换、多⽅案选优、⽂档⽣成等常⻅应⽤场景，以及严厉语⽓、合理质疑等提升准确度的技巧。
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3Dp5ESnqCQS2uLViaSic6KDcXjXBvs3naEY8BIk82zwib00r5r3OjwIFgWeOtqDbyVibpF3Vaoibh8VRYhLPdib0feNdngbZicmGNKho/640?wx_fmt=png&from=appmsg#imgIndex=3)

同时，我们还基于此提供了对应的MCP速查工具「天猫新品业务编码助手」，后端同学通过可以直接通过工具对话来获取自己想要的页面模版，输入自己的需求后，即可得到一份标准化的页面 PRD 来提供给 AI 进行页面生成。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp0OkLwib4Hc2neAugqdo0u1cScHxaI6O1iaRicsAlnrd7XMyuPhLribZ8OJQFtFTIguiaiaw358VICwraBXGYZCD9p6Wic90ICzGjmUicg/640?wx_fmt=png&from=appmsg#imgIndex=5)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp1uia5mcCKiah2pGXibVE1HIFqKKiaiceW8ZDhpZOPN1gLRfTz3jD6GEcZ204algSFPfXnFlicBZlguictqzUyR5FvibwAibTic2E70hSMdc/640?wx_fmt=png&from=appmsg#imgIndex=7)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3yBqIXxDaphrYoJMtdcRHCqX6KUHuq1Y5VLj4gmmibc5FFVuhooBY9otghATjnEhz4omTcnOQia2b93FzfMAJkk4YXn992TwFpE/640?wx_fmt=png&from=appmsg#imgIndex=9)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3Acd90muej6Y4jk9yNicNxv7WvEOqN7JDOtRz5hl17zDzVThZO7ZVPl37ib6u3Eflia4C6XEHIibDgBwXxk5ibQpfeQEaW088z9lyc/640?wx_fmt=png&from=appmsg#imgIndex=11)
- 使用文件链接进行文档的多级管理与索引，渐进式披露，不会过度占用 token![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2odNRgWbhffljcKTANjnI6ibXnOO3oIpdXodjd8bibTDbLUnHiadw0pVYOibkXz0AwZQMmc9kpruA7RQ5B2OcQMMQSgXsGrzKdg8I/640?wx_fmt=png&from=appmsg#imgIndex=13)
- AI 可以直接通过 curl 命令读取 npm 包下的 cdn 资源，从中获取必要知识，不依赖具体编码工具，且接入简单，直接配置在编辑器Rules即可；

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp16s9LYlZjIJNNltf4XOjeJELnVRDeNXia43p31c1uupg8MlyUNHJRYLVYEuq4BYRjbUqnfHnseNKS05rhgcBbwlVIDdEhG87y8/640?wx_fmt=png&from=appmsg#imgIndex=15)
- 甚至还可以直接借用CodeWiki进行知识库问答

![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp3Nh6iawuxnBHfS6rXsKEvuJiaDuOicGibibNpvaOCWsmibhP27rGTgrwSh39XwYqP08OBib8hXrZu9zeKicOUb84YPrYgqWSbH8QLQxLI/640?wx_fmt=png&from=appmsg#imgIndex=17)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp10bWKEoKacvGx0YE5v8SrAJag2BibKEpuJ2rIpjdfB5NlNQiajynZvPsYjxibDibiawH1cfOI1xWZGb3fCibziayDVgEDYHrmwHhaeEc/640?wx_fmt=png&from=appmsg#imgIndex=19)
- 让 AI 基于知识库内容产出技术方案，并进行人工审核（后期考虑提供专用的技术方案 Agent，并进行技术方案的打分评测）
- 开发流程中的工具辅助（走查辅助、接口查询、页面检查MCP）

![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp19b4waZQpJXOcM39eJhqeMKTdxHFMHDiberO1lqicaPvOhsVnHQcfxzu7bcm7hf8nmG6HR58zPqiaur0icrickB6vxT3UKlb4Aq9tA/640?wx_fmt=png&from=appmsg#imgIndex=21)
...
![图片](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM6NqGO0jbSAUicl7Yl59ARfOncxVMib5Lg8TT3KLxahibFpReOvW7LHH4FW9TL9UqNquPHbXVgicXDT2qdQU4bMjVSlwRZWxcyBc9fRFdxKjBibgKQ/640?wx_fmt=svg&from=appmsg#imgIndex=23)

理想化的C端纯 AI Coding 流程

##

![图片](https://mmbiz.qpic.cn/mmbiz_png/33P2FdAnju8PWonAvnSfAGMpeE3YoiaMheQKuLem4UiaZ7XfZBWlxAE6V7h1gWKibiaTgJFYhic2cK9icSpiaS9raEyOA/640?wx_fmt=png&from=appmsg#imgIndex=25)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2tbHFlhricdEzheEYQUWZ7UuEWlFhXibWAvNvzfvWH9lBAj0352M3lUGaOuD7CMr4w16VsFvpom4P4ooicf67pYv6En5kxIriatSo/640?wx_fmt=png&from=appmsg#imgIndex=27)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2a72XxQZI8VWXcZEerTRNYC30xYDMTEWLqMWuU7ncLHGnHtvjEM2BMWhmfkC1uYGE8lMkDvfzcf4bSxkiaOLqAUvt1IA5t78NE/640?wx_fmt=png&from=appmsg#imgIndex=29)

让 AI 去操作 AI，开发者只思考需求是什么

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp39AL8z18eaPzKVxjCJsLq1j1lm6uZbXxCxGYaBZ8LL4seOxX6cHWYwLKRIWmm2mWU03oBWncz8ut2ZI4qkdGvNzm5XiaxpPJibo/640?wx_fmt=png&from=appmsg#imgIndex=31)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vv